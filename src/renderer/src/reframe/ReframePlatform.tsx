...
import { Wrench, ArrowUpRight, FileText, Rocket } from 'lucide-react'
      ...
      {mode === 'client' && (
        <div className="fixed bottom-12 right-6 flex items-center gap-2 z-50 animate-in fade-in slide-in-from-bottom-2 duration-200">
          ...
          <button
            ...
            className="px-3.5 py-1.5 rounded-full bg-zinc-800/95 hover:bg-zinc-700 text-zinc-200 hover:text-white text-xs font-semibold shadow-2xl flex items-center gap-1.5 backdrop-blur border border-zinc-700/60 transition-all group"
