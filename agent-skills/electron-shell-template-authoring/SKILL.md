...
A **template** is an app shape: pages + layout + a default preset. Eleven ship today.
Adding a 12th means respecting the lazy-loading architecture — the one place in
